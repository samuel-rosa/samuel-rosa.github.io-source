...
abstract_short: 'Nós avaliamos se o investimento em covariáveis ambientais mais detalhadas, do ponto de vista espacial, melhora a acurácia no mapeamento digital do solo. No geral, o aumento no desempenho das predições espaciais foi modesto, podendo não superar os custos adicionais de usar covariáveis mais detalhadas. Assim, pode ser mais eficiente gastar os recursos adicionais na coleta de mais observações do solo, ou então aumentando o detalhe espacial apenas das covariáveis que têm o maior efeito de melhoria nas predições espaciais.'
