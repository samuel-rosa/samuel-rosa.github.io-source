...
1. A evolução do mapeamento de solos: paradigmas e qualidade dos mapas de solo [acesso][jean]
2. Uma retrospectiva da modelagem em solos [acesso][luciano]
3. O paradigma da ciência do solo e a qualidade das  informações contidas nos mapas de solo [acesso][taciara]

[jean]: https://www.authorea.com/203628/8YpW_1JOXjfiZBIy6TnV7g
[luciano]: https://www.authorea.com/203514/Xys0MAYo-3VWQUjF4l5Wwg
[taciara]: https://www.authorea.com/203627/IYYDl4Z2kn_Ha-JUQw9g1Q
...
* `r cite_text("Webster2000")` <!-- SoPressupostos do modelo geoestatístico->

Leia também, pelo menos, dois dos artigos a seguir:

* `r cite_text("McbratneyEtAl1986")` <!-- Semivariograma e funções autorizadas -->
* `r cite_text("WarrickEtAl1987")` <!-- Amostragem para estimar o variograma -->
* `r cite_text("Myers1989")` <!-- Estacionaridade -->
* `r cite_text("Heuvelink1996")`  <!-- Modelos de variação espacial -->

## Semana 2, 11-Outubro: Propriedades dos dados espaciais

**Temas**: Observações dependentes e preferenciais. Resíduos espacialmente correlacionados. O A visão estocástica do modelo contínuo de variação espacial. processo gerador aleatório e espacialmente autocorrelacionado. A Semivariância e modelos matemáticos do semivariograma empírico.*<!-- A estacionariedade de primeira e segunda ordem. -->*
Tarefas para a próxima semana**: 
