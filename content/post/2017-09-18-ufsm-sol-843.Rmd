...
* `r cite_text("Lark2000")` <!-- Máxima verossimilhança -->
* `r cite_text("MinasnyEtAl2005")` <!-- Função de covariância Matérn -->
* `r cite_text("HenglEtAl2007b")` <!-- Regressão krigagem -->
...
* `r cite_text("Lark2012")` <!-- Modelo linear misto de variação espacial na ciência do solo -->

Leia também, pelo menos, um dos artigos a seguir:

* `r cite_text("HeuvelinkEtAl1999")` <!-- Suporte amostral e de predição -->
* `r cite_text("LarkEtAl2006")` <!-- REML + E-BLUP -->
* `r cite_text("BrusEtAl2011")` <!-- Amostragem probabilística para validação estatística -->
* `r cite_text("KempenEtAl2012a")` <!-- Extensão do modelo linear misto à variáveis categóricas -->
...
* `r cite_text("Goovaerts1999")` <!-- Diversos aspectos da geoestatística, inclusive simulação -->
* `r cite_text("HeuvelinkEtAl2007a")` <!-- Modelos de incerteza para objetos variados -->
