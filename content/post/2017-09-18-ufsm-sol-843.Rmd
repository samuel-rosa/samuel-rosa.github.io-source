...
biblio <- bibtex::read.bib("~/Dropbox/jabref/biblio.bib")
cite_text <- 
  function (bibkey) {
...
1.1. A evolução do mapeamento de solos: paradigmas e qualidade dos mapas de solo ([acesso][jean])
2. Uma retrospectiva da modelagem em solos ([acesso][luciano])
3. O paradigma da ciência do solo e a qualidade das  informações contidas nos mapas de solo ([acesso][taciara])[jLeituras para a próxima semana**:
...
1.1. A evolução do mapeamento de solos: paradigmas e qualidade dos mapas de solo ([acesso][jean])
2. Uma retrospectiva da modelagem em solos ([acesso][luciano])
3. O paradigma da ciência do solo e a qualidade das  informações contidas nos mapas de solo ([acesso][taciara])**[jean]: https://www.authorea.com/203628/8YpW_1JOXjfiZBIy6TnV7g
...
* `r cite_text("Webster2000")` <!-- Pressupostos do modelo geoestatístico -->

Leia também, pelo menos, um dos artigos a seguir:

* `r cite_text("McbratneyEtAl1986")` <!-- Semivariograma e funções autorizadas -->
* `r cite_text("WarrickEtAl1987")` <!-- Amostragem para estimar o modelo do semivariograma -->
* `r cite_text("Myers1989")` <!-- Estacionaridade -->
<!-- * `r cite_text("Lark2000a")` Estimadores robustos do variograma -->
...
* `r cite_text("HeuvelinkEtAl2001")` <!-- Modelos de variação espacial e temporal -->
