...
aula `r smiley`) As leituras dirigidas servirão de base para as discussões a serem incitadas pelo instrutor 
...
(nós trataremos sobre o repositório no [encontro de nivelamento](#semana-zero) `r smiley`). Esse repositório 
...
planejamento rigoroso e metas realistas `r smiley`)
...
a versão *Preview* do RStudio `r smiley`) Estudo do sistema [git](https://git-scm.com/) de gerenciamento de 
...
* `r cite_text("Myers1989")` <!-- Estacionariedade -->
...
* `r cite_text("Goovaerts2001")` <!-- Modelagem geoestatística da incerteza -->
...
* `r cite_text("OliverEtAl1991")` <!-- Usos diversos da geoestatística -->
